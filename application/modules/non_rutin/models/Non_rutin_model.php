...
class Non_rutin_model extends BF_Model
{
    ...
    public function query_data_json_non_rutin_approval_head($tanda = null, $like_value = NULL, $column_order = NULL, $column_dir = NULL, $limit_start = NULL, $limit_length = NULL)
    {
