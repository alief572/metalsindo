...
class Inventory_4_model extends BF_Model
{
	...
	public function GetMaterial($id_category3)
	{
		...
		$this->db->select('a.*, b.nama as nama_type , c.nilai_dimensi as thickness, d.nm_bentuk as nm_bentuk');
	...
	public function get_total_stock($id_category3)
	{
		$this->db->select('COALESCE(SUM(totalweight), 0) as total_stock');
		$this->db->from('stock_material');
