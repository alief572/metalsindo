...
?>
 ...
 <div class="box box-primary">
    <div class="box-body">
		...
		<th><input type='text' class='form-control weight_actualpl' 	id='weight_actualpl' onkeyup='hitungNGpackinglist()'required name='weight_actualpl'></th>
		
		<th><input type='text' class='form-control kg_sisa' id='kg_sisa'	value='<?= $tr_spk->sisa?>'  	readonly required name='kg_sisa'></th>
		
		<th><input type='text' class='form-control kg_sisa_actual' 	id='kg_sisa_actual' onkeyup='hitungActualweightproses()' required name='kg_sisa_actual'></th>		
		</tr>
		</tbody>
		...
		<tfoot>
            ...
            <td width='7%'><input type='text' class='form-control ng_packinglist1' name='ng_packinglist1' readonly></td>
            <td width='7%'><b>Actual weight proses</b></td>
            <td width='7%'><input type='text' class='form-control actualweightproses' name='actualweightproses' readonly></td>
			</tr>
		</tfoot>
		...
		<div class="col-sm-12">
			...
			<tbody id="list_spk">
			<?php $i=0;
			foreach ($results['dt_spk'] as $dt_spk){$i++; 
						...
						$spkmar = $nosurat->no_surat;
							  ...
							  for($loop1=0;$loop1<$countfiles;$loop1++){
								...
								<tr id='tr_$i$loop'>
									...
									<th>
									<input type='text' class='form-control'   		value='$tr_spk->lotno -$loop' 		readonly id='used_lot_slitting_$i$loop' required name='dt[$i$loop][lot_slitting][]'></th>
									...
									<th>
									<input type='text' class='form-control dt_qtywidth autoNumeric'  	onblur='HitungTotalberat($i$loop)'	value='$dt_spk->qtywidth' 	 id='used_qtywidth_$i$loop' required name='dt[$i$loop][qtywidth][]'>
            ...
            <th align='right' width='7%'><input type='text' class='form-control Number' id='widthproduksi' value=<?= number_format($totalwidth,2)?> required name='widthproduksi'  readonly></th>
            <th width='7%'></th>
           <th width='15%'>Actual Weight produksi </th>
			<th width='7%'><input type='text' class='form-control Number' id='weightproduksi' value='0' required name='weightproduksi'  readonly></th>
			<th width='10%'></th>
            </tr>
            ...
            <th align='right' width='7%'><input type='text' class='form-control Number' id='widthmothercoil' value=<?= $tr_spk->width?> name='widthmothercoil'  readonly></th>
            <th width='7%'></th>
           <th width='15%'>Actual Weight Proses </th>
			<th width='7%'><input type='text' class='form-control Number' id='weightproses' value='0' required name='weightproses'  readonly></th>
			<th width='10%'></th>
            </tr>
            ...
            <th align='right' width='7%'><input type='text' align='right' class='form-control' id='widthsisa' value=<?= number_format($tr_spk->width - $tr_spk->lpegangan - $totalwidth,2) ?> name='widthsisa'  readonly></th>
            <th width='7%'></th>
           <th width='15%'>Actual Weight sisa </th>
			<th width='7%'><input type='text' class='form-control Number' id='weightsisa' value='0' required name='weightsisa'  readonly></th>
			<th width='10%'></th>
            </tr>
        ...
        <tr class='bg-blue'>
		 ...
		 <tr>
            ...
            <td width='15%'>
			<input type='number' class='form-control' value="0" id='bpackinglist' onkeyup required name='bpackinglist' readonly >
			</td>
		 ...
		 <tr>
            ...
            <td width='15%'><input type='number' class='form-control' id='baktualmother' value="0" onkeyup required name='baktualmother' readonly  ></td>
        ...
        <tr class='bg-green'>
		  ...
		  <tr>
            ...
            <td width='15%'><input type='number' class='form-control' id='lfinishgood' value=<?= number_format($totalwidth,2)?> required name='lfinishgood' readonly ></td>
            <td width='15%'>
			<input type='number' class='form-control' value="0" id='bfinishgood' onkeyup required name='bfinishgood' readonly >
			</td>
		 ...
		 <tr>
            ...
            <td width='15%'><input type='number' class='form-control' id='lsisa_aktual' value="0" onkeyup required name='lsisa_aktual'  ></td>
            <td width='15%'>
		 ...
		 <tr>
            ...
            <td width='15%'><input type='number' class='form-control' id='lscrap_aktual' value="0"  onkeyup required name='lscrap_aktual'  ></td>
            <td width='15%'><input type='number' class='form-control' id='bscrap_aktual' value="0" onkeyup required name='bscrap_aktual'  ></td>
	...
	<div class="col-sm-12">
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<input type='number' class='form-control difference' id='difference' value="0" name='difference' readonly >
			</div>
			</div>
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<input type='number' class='form-control differencepercent' id='differencepercent' value="0" name='differencepercent' readonly >
			</div>
			</div>
		</div>
...
<script type="text/javascript">
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'spk_aktual_booking/SaveEditHeader';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
	...
	function hitungNGpackinglist(){
		...
		$('.ng_packinglist1').val(number_format(totalNgpl*(-1),2));
		$('.ng_packinglist').val(number_format(totalNgpl*(-1),2));
