...
class Spk_aktual_booking extends Admin_Controller
{
    //Permission
    ...
    public function __construct()
    {
        ...
        $this->load->model(array('Spk_aktual_booking/Inventory_4_model',
    ...
    public function index()
    {
       $this->auth->restrict($this->viewPermission);
        ...
        $produksi = $this->Inventory_4_model->CariSPK2();
		 $aktual = 	$this->db->query("SELECT * FROM tr_spk_aktual WHERE sts_over='1' ORDER BY created_on DESC")->result();
		$data = [
			'produksi' => $produksi,
			'aktual' => $aktual
		];
