...
<div class="box box-primary">
    <div class="box-body">
		<form id="data-form" method="post">
			...
			<div class="row">
		<center><label for="customer" ><h3>Poforma Invoice</h3></label></center>
		<div class="col-sm-12">
		    <div class="col-sm-6">
		        <div class="form-group row">
			        <div class="col-md-4">
				        <label for="customer">No Proforma Invoice</label>
			        </div>
		...
		<div class="col-sm-12">
			...
			<div class="col-sm-6">
		        <div class="form-group row">
					...
					<button type="submit" class="btn btn-success btn-sm" name="save" id="simpan-com"><i class="fa fa-save"></i>&nbsp;Create Proforma Invoice</button>
                    <a class="btn btn-danger btn-sm" href="<?= base_url('/wt_invoicing/spk_marketing') ?>"  title="Edit">Kembali</a>
