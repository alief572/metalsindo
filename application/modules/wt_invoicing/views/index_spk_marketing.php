	...
	<div class="box-body">
		...
		<tr>
			...
			<td style="padding-left:20px">
				<?php if($ENABLE_MANAGE) : ?>
				<a class="btn btn-success btn-sm" href="<?= base_url('/wt_invoicing/createInvoice/'.$record->id_spkmarketing) ?>" title="Create Invoice" data-no_inquiry="<?=$record->no_inquiry?>"><i class="fa fa-check">&nbsp;Create Invoice</i>
				</a> 
				
				<a class="btn btn-warning btn-sm" href="<?= base_url('/wt_invoicing/createProformaInvoice/'.$record->id_spkmarketing) ?>" title="Create Proforma Invoice" data-no_inquiry="<?=$record->no_inquiry?>"><i class="fa fa-check">&nbsp;Create Proforma Invoice</i>
				</a> 
			<?php endif; ?>
