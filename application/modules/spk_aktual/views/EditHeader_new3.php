						...
						<div class="form-group row">
							<div class="col-sm-12">
								...
								<tr id='tr_$loop'>
									...
									<th>
									<input type='text' class='form-control'   		value='$dt_spk->width' 			readonly id='used_width_$loop' onkeyup='HitungTotalCoil($loop)' required>
									<input type='hidden' value='$dt_spk->weight' name='dt[$loop][width][]'>
									...
									<th>
									<input type='text' class='form-control dt_qtywidth'  	onblur='HitungTotalberat($loop)'	value='$dt_spk->qtysatuan' tabindex='1'	 id='used_qtywidth_$loop' required name='dt[$loop][qtywidth][]'>
							...
							<table class='table table-bordered table-striped'>
								...
								<tr>
									...
									<td width='15%'><input type='hidden' class='form-control' id='lscrap_aktual' value=<?= $tr_spk->lscrap_aktual ?> onkeyup required name='lscrap_aktual'>
										<input type='text' class='form-control' id='coil_scrap' name='coil_scrap' value=<?= $tr_spk->coil_scrap ?>Placeholder="Qty Coil Scrap">
									</td>
