		...
		<form id="data-form" method="post">
			<div class="col-sm-12">
				<div class="row">
					...
					<div class="col-sm-12 ngIN">
						...
						?>
								<div class="col-sm-12 ngINApp">
									<div class="form-group row">
										<div class="col-md-2">
											<label class="text-red"><?php if ($nomor == 1) {
																		echo "NG INTERNAL";
																	} ?></label>
										</div>
										<div class="col-md-2">
					...
					<center>
						<a class="btn btn-success btn-sm" href="<?= base_url('/spk_aktual/printSPKProduksi/' . $id_spkproduksi) ?>" target="_blank" title="Print SPK Produksi"><i class="fa fa-print">&nbsp;</i>Print SPK Produksi</i></a>
...
<script type="text/javascript">
	...
	function CariDetail(id) {
		...
		$.ajax({
			type: "GET",
			url: siteurl + 'spk_aktual/CariW1material',
			data: "id_marketing=" + id_marketing + "&id=" + id,
			success: function(html) {
		...
		$.ajax({
			type: "GET",
			url: siteurl + 'spk_aktual/CariW2material',
