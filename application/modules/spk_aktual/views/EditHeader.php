						...
						<div class="col-sm-12">
							...
							<table class='table table-bordered table-striped'>
								...
								<tr>
									...
									<td width='15%'><input type='hidden' class='form-control' id='lscrap_aktual' value="0" onkeyup required name='lscrap_aktual'>
										<input type='text' class='form-control' id='coil_scrap' name='coil_scrap' Placeholder="Qty Coil Scrap">
									</td>
