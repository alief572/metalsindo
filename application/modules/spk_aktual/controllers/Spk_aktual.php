...
class Spk_aktual extends Admin_Controller
{
	...
	public function RejectToProduksi()
	{
		...
		if (!empty($get_id_stock[0]->id_stock)) {
			...
			$this->db->query("UPDATE stock_material SET sisa_potongan=NULL,detail_potongan=NULL, sisa_spk=$weight, on_proses=NULL WHERE id_stock='$idstok'");
