...
<script type="text/javascript">
	...
	$(document).on('click', '.edit', function(e){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'asset_category/editCategory/'+id,
	...
	$(document).on('click', '.view', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'asset_category/viewCategory/'+id,
			data:{'id':id},
			success:function(data){
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
		...
		$.ajax({
			type:'POST',
			url:siteurl+'asset_category/addKategory',
			success:function(data){
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
	...
	$(document).on('click', '.delete', function(e){
		...
		function(){
		  $.ajax({
			  type:'POST',
			  url:siteurl+'asset_category/deleteKategory',
			  dataType : "json",
			  data:{'id':id},
