			...
			<div class="col-md-12">
				<div class="form-group row">
							<div class="col-md-4">
							 ...
							 <div class="col-md-8">
							  <input type="text" class="form-control" id="nm_category" required name="nm_category" value="<?= $record->nm_category ?>" placeholder="Nama Kategory Asset">
							  </div>
							...
							<div class="col-md-4">
							 ...
							 <div class="col-md-8">
								<select type="text" class="form-control" id="tipe" name="tipe">
									...
									<?php if ($record->tipe == 'BERGERAK'){ ?>
									<option value="BERGERAK" selected >BERGERAK</option>
									<option value="TIDAK BERGERAK">TIDAK BERGERAK</option>
									<?php }else{?>
									<option value="BERGERAK" >BERGERAK</option>
									<option value="TIDAK BERGERAK" selected>TIDAK BERGERAK</option>
									<?php
									}?>
								</select>
							</div>
  ...
  $(document).ready(function() {
    ...
    $(document).on('submit', '#data_form', function(e){
		...
		function(){
		  $.ajax({
			  type:'POST',
			  url:siteurl+'asset_category/saveEditcategory',
			  dataType : "json",
			  data:data,
