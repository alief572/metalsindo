...
<div class="box">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4" style="margin-top: 2vh;">
                <div class="panel panel-default">
                    <div class="panel-heading bg-light-blue">PO Non Material</div>
                    <div class="panel-body">
                        ...
                        foreach ($data as $item_transportasi) :
                            if ($item_transportasi->tipe == 'transportasi') {
                                ...
                                if ($ENABLE_MANAGE && $get_sts_payment['status'] < 1) : ?>
                                    <div class="text-center"><a href="<?= base_url($this->uri->segment(1) . '/approval_payment_checker/?type=' . $item_transportasi->tipe . '&id=' . $item_transportasi->id . '&nilai=' . $item_transportasi->jumlah); ?>" name="save" class="btn btn-primary btn-sm"><i class="fa fa-check-square-o">&nbsp;</i>Approve</a></div>
                    ...
                    <tbody>
                        ...
                        foreach ($data as $item_po_material) :
                            ...
                            if ($item_po_material->tipe == 'po_material') {
                                ...
                                echo '<td>';
                                if ($ENABLE_MANAGE && $get_sts_payment['status'] < 1) : ?>
                                    <div class="text-center"><a href="<?= base_url($this->uri->segment(1) . '/approval_payment_checker/?type=' . $item_po_material->tipe . '&id=' . $item_po_material->id . '&nilai=' . $item_po_material->jumlah); ?>" name="save" class="btn btn-primary btn-sm"><i class="fa fa-check-square-o">&nbsp;</i>Approve</a></div>
