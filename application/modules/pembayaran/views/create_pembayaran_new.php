						...
						<div class="col-sm-6 form-horizontal">
							...
							<div class="row">
								<div class="form-group ">
									...
									<div class="col-sm-6">
										<input type="date" name="tgl_terima_invoice" id="tgl_terima_invoice" class="form-control input-sm tanggal" value="<?php echo date('Y-m-d') ?>">
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="form-group">
								<label for="jenis_invoice" class="col-sm-4 control-label">Mata Uang </font></label>
								<div class="col-sm-6">
									<select class="form-control input-sm select2" name="matauang" id="matauang">
			...
			<div class="nav-tabs-custom">
				<div class="box active ">
					<ul class="nav nav-tabs">
						<li class="add"><a href="#" data-toggle="tab" id="tambah2">Add Request</a></li>
			...
			<table class="table table-bordered" width="100%" id="tabel-detail-mutasi">
				<thead>
					<tr class="bg-blue">
						...
						<th class="text-center">Sisa Request USD</th>
						<th class="text-center">Sisa Request</th>
		...
		<div class="box active">
			<div class="box-body">
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="form-group ">
							<label class="col-sm-4 control-label">Total Bayar Request</label>
							<div class="col-sm-6">
				...
				swal({
					...
					function(isConfirm) {
						if (isConfirm) {
							...
							$.ajax({
								url: siteurl + "pembayaran/save_pembayaran",
								dataType: "json",
								type: 'POST',
								data: formdata,
