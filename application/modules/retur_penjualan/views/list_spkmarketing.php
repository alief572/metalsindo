...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
			...
			<?php if($ENABLE_MANAGE) : ?>
			<a class="btn btn-info btn-sm" href="<?= base_url('/retur_penjualan/proses_incoming/'.$record->id_spkmarketing) ?>"  title="Edit"><i class="fa fa-edit">&nbsp;</i></i></a>
				</a>
			<?php endif; ?>
