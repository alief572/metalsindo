 ...
 <div class="box box-primary">
    <div class="box-body">
		...
		<div class="col-sm-12">
			...
			$dt =$this->db->query("SELECT a.* FROM dt_spk_aktual_detail_sheet as a  where a.id_tr_spk_produksi = '".$idtr."'")->result();
			...
			if($surat <> 'NONSPK'){
				$spkmar = $nosurat->no_surat;
								...
								<tr id='tr_$loop'>
									...
									<th> <input type='text' class='form-control' 		value='$dt_spk->density' 		readonly id='used_density_$i$loop' required name='dt[$i$loop][density]'></th>
									...
									<th>
									<input type='text' class='form-control'   		value='$dt_spk->width_sheet' 			readonly id='used_width_$loop' onkeyup='HitungTotalCoil($loop)' required name='dt[$loop][width][]'>
									...
									<th><input type='text' class='form-control'   		value='$dt_spk->length_sheet' 	 id='used_length_$i$loop' required name='dt[$i$loop][length][]' readonly></th>  
									
									<th>
									  <input type='text' class='form-control'   		value='$dt_spk->qty_persheet' 	 id='used_widthperkg_$i$loop' required name='dt[$i$loop][widthperkg][]' readonly>
									</th>
									...
									<th>
									<input type='text' class='form-control' value='$dt_spk->qtysheet' readonly id='used_qtysheet_$i$loop'  required name='dt[$i$loop][qtysheet]'>
									</th>
        ...
        <tr class='bg-green'>
		  ...
		  <tr>
            ...
            <td hidden width='15%'><input type='text' class='form-control' id='lfinishgood' value=<?= $tr_spk->lfinishgood?> required name='lfinishgood' readonly ></td>
            <td width='15%'>
		 ...
		 <tr>
            ...
            <td hidden width='15%'><input type='text' class='form-control' id='lsisa_aktual' value=<?= $tr_spk->lsisa_aktual?>  onkeyup required name='lsisa_aktual'  ></td>
            <td width='15%'>
		 ...
		 <tr>
            ...
            <td hidden width='15%'><input type='text' class='form-control' id='lscrap_aktual' value=<?= $tr_spk->lscrap_aktual?>   onkeyup required name='lscrap_aktual'  ></td>
