...
<body>
    ...
    <table class='gridtable' width='100%'  align="left" border='1' cellpadding='2'>
        <tr>
            ...
            <td width='7%'>Weight Order</td>
            <td width='7%'>Weight Shearing</td>
            <td width='15%'>Lot Number Shearing</td>
			<td width='7%'>Actual <br>Weight<br>Shearing</td>
        </tr>
        <?php 
        $loop=0;
        ...
        ?>
            <tr>
                ...
                <td width='30'  style='vertical-align:top;' align='right'><?=number_format($dt_spk['weight_order'],2);?></td>
				<td width='30'  style='vertical-align:top;' align='right'><?=number_format($dt_spk['weight_proses'],2);?></td>
