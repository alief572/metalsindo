...
<form id="form-header-mutasi" method="post">
    <input type="hidden" name="id_rec_inv_ap" value="<?= $header->id_rec_inv_ap ?>">
                        ...
                        <div class="col-sm-6 form-horizontal">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea name="ket_bayar" class="form-control input-sm" id="ket_bayar"><?= $header->keterangan_bayar ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input name="no_invoice" class="form-control input-sm" id="no_invoice" value="<?= $header->no_invoice ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control input-sm chosen_select" name="supplier" id="supplier">
                                            ...
                                            foreach ($list_supplier as $item) {
                                                if ($item->id_suplier == $header->id_suplier) {
    ...
    <div class="box box-default ">
        ...
        <div class="box-body">
            <table class="table table-bordered" width="100%" id="tabel-detail-mutasi">
                ...
                <tbody id="list_item_mutasi">
                    ...
                    foreach ($detail as $item) {
                        ...
                        echo '<tr class="tr_inc_add_' . $no . '">';

                        echo '<td class="text-center">';
                        echo $item->id_incoming;
                        echo '<input type="hidden" name="kp[' . $no . '][id_incoming]" value="' . $item->id_incoming . '">';
                        echo '</td>';
                        ...
                        echo '<td class="text-center">';
                        echo $item->nm_suplier;
                        echo '<input type="hidden" name="kp[' . $no . '][id_suplier]" value="' . $item->id_suplier . '">';
                        echo '<input type="hidden" name="kp[' . $no . '][nm_suplier]" value="' . $item->nm_suplier . '">';
                        echo '</td>';
                        ...
                        echo '<td class="text-center">';
                        echo '<input type="text" class="form-control form-control-sm" name="kp[' . $no . '][no_faktur_pajak]" value="' . $item->no_faktur_pajak . '" >';
                        echo '</td>';

                        echo '<td class="text-center">';
                        echo '<input type="text" class="form-control form-control-sm text-right hitung_total divide" name="kp[' . $no . '][ppn]" data-no="' . $no . '" value="' . $item->ppn . '" >';
                        echo '</td>';
                        ...
                        echo '<td class="text-center">';
                        echo '<button type="button" class="btn btn-sm btn-danger del_added_inc" data-no="' . $no . '" title="Remove Incoming">';
            ...
            <button type="button" class="btn btn-sm btn-primary" onclick="savemutasi()">
        ...
        swal({
            ...
            function(isConfirm) {
                if (isConfirm) {
                    ...
                    $.ajax({
                        url: siteurl + active_controller + "update_receive_invoice_ap",
                        dataType: "json",
                        type: 'POST',
                        data: formdata,
