                        ...
                        <div class="col-sm-6 form-horizontal">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input name="no_faktur_pajak" class="form-control input-sm" id="no_faktur_pajak" value="<?= $header->no_faktur_pajak ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" 
                                       ...
                                       readonly value="<?= number_format($ttl_total + $header->ppn, 2) ?>">
                            </div>
                        </div>
                    </div>
                </div>
