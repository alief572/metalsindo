                        ...
                        <div class="col-sm-6 form-horizontal">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea name="ket_bayar" class="form-control input-sm" id="ket_bayar" readonly><?= $header->keterangan_bayar ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
...
<script>
    ...
    */
    ...
    $(document).on('change', '.hitung_total', function() {
        ...
        var total = parseFloat(nilai + (nilai * nilai_ppn / 100));
