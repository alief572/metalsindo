...
class Receive_invoice_ap_model extends BF_Model
{
  ...
  public function __construct()
  {
    ...
    $this->ENABLE_ADD     = has_permission('Receive_Invoice_AP.Add');
    $this->ENABLE_MANAGE  = has_permission('Receive_Invoice_AP.Manage');
    $this->ENABLE_VIEW    = has_permission('Receive_Invoice_AP.View');
    $this->ENABLE_DELETE  = has_permission('Receive_Invoice_AP.Delete');
  }
