...
<div class="po-form-banner">
	<div class="po-form-banner-title">
		<h3><i class="fa fa-pencil-square-o" style="margin-right: 8px;"></i>Buat Purchase Order (Coil / Slitting)</h3>
		<p>Silakan isi informasi supplier, detail material, dan ketentuan PO di bawah ini.</p>
	</div>
	<div>
				...
				<div class="table-responsive">
					<table class='table table-bordered table-striped table-custom' style="margin-bottom: 0;">
						...
						<tbody id="data_request">
							<tr>
								<td colspan='14' class="text-center" style="padding: 24px; color: #94a3b8;">
									<i class="fa fa-info-circle"></i> Silakan pilih supplier dan PR di atas untuk memuat daftar material.
								</td>
							</tr>
						</tbody>
					</table>
