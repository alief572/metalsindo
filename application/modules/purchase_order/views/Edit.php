...
<div class="po-form-banner">
	<div class="po-form-banner-title">
		<h3><i class="fa fa-pencil-square-o" style="margin-right: 8px;"></i>Edit Purchase Order: <?= $head->no_surat ?></h3>
		<p>Ubah informasi PO, detail material, atau ketentuan order di bawah ini.</p>
	</div>
	<div>
...
<form id="data-form" method="post" autocomplete='off'>
	<div class="input_fields_wrap2">
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="form-group row">
							...
							<div class="col-md-8">
								<input type="text" class="form-control" id="no_pr" value="<?= $head->no_pr ?>" required name="no_pr" readonly style="background:#f1f5f9;">
							</div>
						</div>
						<div class="form-group row">
							<div class="col-md-4">
		...
		<!-- Section 3: Daftar Material PO -->
		<div class="po-section-card">
			<div class="po-section-header">
				<h4><i class="fa fa-cubes" style="margin-right: 6px;"></i>Daftar Item Material Purchase Order</h4>
			</div>
					...
					<table class='table table-bordered table-striped table-custom' style="margin-bottom: 0;">
						<thead>
							<tr>
								...
								<th width='8%' class="text-right">Rate LME</th>
								<th width='7%' class="text-right">Alloy Price</th>
								<th width='7%' class="text-right">Fab Cost</th>
