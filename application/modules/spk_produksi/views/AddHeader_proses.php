					...
					<div class="col-sm-12">
						...
						<div class="col-sm-6">
							<div class="form-group row">
								...
								<div class="col-md-4">
									<input type='text' class='form-control autoNumeric' id='process' name='process' >
								</div>
								<div class="col-md-4">
									<input type='text' class='form-control' id='kg_process' name='kg_process' readonly >
								</div>
							</div>
						</div>
					</div>
								...
								<table class='table table-bordered table-striped'>
									<thead>
										<tr class='bg-blue'>
											...
											<th width='5%'>Order</th>
											<th width='5%'>Produksi</th>
											<th width='5%'>Stok FG</th>
...
<script type="text/javascript">
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'spk_produksi/SaveNewHeaderproses';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
	...
	function HitungTotalCoil(id){
		...
		$.ajax({
            ...
            success:function(html){
			   ...
			   var coil =  parseFloat(qtycoil)+parseFloat(qcoil);
			   $('#qcoil').val(coil);
	...
	function CariDetail(id){
		...
		$.ajax({
            type:"GET",
            url:siteurl+'spk_produksi/CariKeterangan',
            data:"id_marketing="+id_marketing+"&id="+id,
            success:function(html){
               $('#keterangan_'+id).html(html);
