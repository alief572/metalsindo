...
class Spk_aktual_slitting extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model(array('Spk_aktual_slitting/Inventory_4_model',
    ...
    public function index()
    {
       $this->auth->restrict($this->viewPermission);
		...
		WHERE a.slitting='Y' AND a.approve <> '2'
		 ")->result();
...
function cari_inven1()
	...
	public function ApproveLHPProduksi(){
		...
		$this->db->where('lotno',$spk_produksi[0]->lot_slitting)->update("stock_material",$oldstock);
