	...
	function AddMaterial()
	{
		...
		foreach ($material as $material) {
			if ($material->id_bentuk == 'B2000001') {
				...
				echo "<option value='$material->id_category3'>$material->id_category3|$material->nama-$material->maker</option>";
				...
				$thickness = $dimensi[0]->nilai_dimensi;
				echo "<option value='$material->id_category3'>$material->bentuk $material->alloy $material->nama $material->hardness $thickness - $material->maker</option>";
			};
		};
		echo "</select></td>
