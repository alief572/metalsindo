...
<form id="form-detail-jurnal" method="post">
   ...
   <input type="text" id="vendor_id" name="vendor_id" value="<?= $id_vendor ?>" class="form-control"  readonly/>
   <input type="text" id="vendor_nm" name="vendor_nm" value="<?= $nama_vendor ?>" class="form-control"  readonly/>
...
$('#proses_bayar').click(function(e) {
	...
	else if(jenis_jurnal=='jurnalpembayaranum'){
		var link ="jurnal_nomor/jurnal_fn/save_jurnal_buk_um";
	}
	else if(jenis_jurnal=='jurnalunbilled'){
		var link ="jurnal_nomor/jurnal_fn/save_jurnal_unbilled";
	}
	else if(jenis_jurnal=='jurnalpembayaranpib'){
		var link ="jurnal_nomor/jurnal_fn/save_jurnal_buk_pib";
	}
