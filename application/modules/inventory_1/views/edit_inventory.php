<?php
    $ENABLE_ADD     = has_permission('Level_1.Add');
    $ENABLE_MANAGE  = has_permission('Level_1.Manage');
    $ENABLE_VIEW    = has_permission('Level_1.View');
    $ENABLE_DELETE  = has_permission('Level_1.Delete');
