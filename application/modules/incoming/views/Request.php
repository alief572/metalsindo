 ...
 <div class="box box-primary">
    <div class="box-body">
		<form id="data-form" method="post">
			...
			<div class="row">
		<center><label for="customer" ><h3>Request Pembayaran AP</h3></label></center>
				<div class="col-sm-12">
		<div class="col-sm-6">
		...
		<div class="col-sm-6">
			...
			<div class="col-md-4">
				<input type="text" id="request_kurs" name="request_kurs" value="<?=number_format(round($po->unbilled_kurs))?>" class="form-control sm divide">
			</div>
			</div>
		</div>
		<div class="col-sm-6">
		<div class="form-group row">
			...
			<div class="col-md-4">
				<input type="text" id="request" name="request" value="<?=number_format(round($po->unbilled_idr))?>" class="form-control sm divide">
			</div>
		</div>
		</div>
