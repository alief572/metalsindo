...
if($po->kurs < 1) {
	...
	$nilai_request_usd = ($po->unbilled_kurs <= 0) ? round($po->nilai_invoice / $po->kurs) : round($po->unbilled_kurs);
}
$nilai_request = ($po->unbilled_idr <= 0) ? round($po->nilai_invoice) : round($unbilled_idr);
					...
					<div class="row">
						...
						<div class="col-sm-12">
							<div class="col-sm-6">
								<div class="form-group row">
									...
									<div class="col-md-4">
										<input type="text" id="no_surat" name="no_surat" class="form-control" value="<?= $po->id_incoming ?>">
										<input type="hidden" id="no_po" name="no_po" class="form-control" value="<?= $po->id_data ?>">
									</div>
								</div>
							</div>
							<div class="col-sm-6">
						...
						<div class="col-sm-12">
							...
							<div class="col-sm-6">
								<div class="form-group row">
									...
									<div class="col-md-4">
										<textarea id="keterangan" name="keterangan" class="form-control sm"> </textarea>
									</div>
								</div>
							</div>
						</div>
						<div class="col-sm-12">
							<div class="col-sm-6">
								<div class="form-group row">
									<div class="col-md-4">
										<label for="customer">Total PO IDR</label>
									</div>
									<div class="col-md-4">
										<input type="text" id="po" name="po" class="form-control sm" value="<?= number_format(round($po->unbilled_idr)) ?>" readonly>
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group row">
									...
									<div class="col-md-4">
										<input type="text" id="loi" name="loi" class="form-control sm" value="<?= $suplier[0]->suplier_location ?>" readonly>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-12">
							<div class="col-sm-6">
								<div class="form-group row">
									<div class="col-md-4">
										<label for="customer">Total PO USD</label>
									</div>
									<div class="col-md-4">
										<input type="text" id="po_usd" name="po_usd" class="form-control sm" value="<?= number_format(round($po->unbilled_kurs)) ?>" readonly>
									</div>
								</div>
							</div>
							<div class="col-sm-6">
						...
						<div class="col-sm-12">
							<div class="col-sm-6">
								<div class="form-group row">
									...
									<div class="col-md-4">
										<input type="text" id="ppn" name="ppn" class="form-control sm divide" value="<?= $po->nilai_ppn ?>">
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group row">
									...
									<div class="col-md-4">
										<input type="text" id="kurs" name="kurs" value="<?= number_format(round($po->kurs)) ?>" class="form-control sm divide" readonly>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-12">
							<div class="col-sm-6">
								<div class="form-group row">
									...
									<div class="col-md-4">
										<input type="text" id="request_kurs" name="request_kurs" value="<?= number_format($nilai_request_usd) ?>" class="form-control sm divide">
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group row">
									...
									<div class="col-md-4">
										<input type="text" id="request" name="request" value="<?= number_format($nilai_request) ?>" class="form-control sm divide">
									</div>
								</div>
							</div>
				...
				swal({
					...
					function(isConfirm) {
						if (isConfirm) {
							...
							var baseurl = siteurl + 'incoming/SaveRequest';
							$.ajax({
								url: baseurl,
								type: "POST",
								data: formData,
