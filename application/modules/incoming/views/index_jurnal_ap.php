	...
	<div class="box-body">
		...
		<tr>
            ...
            <td style="padding-left:20px">			
			    <a class="btn btn-success btn-sm view3" href="javascript:void(0)" title="Create Jurnal" data-id_material="<?=$record->no_request?>"><i class="fa fa-check"></i>
				</a>
...
<script type="text/javascript">
	...
	$(document).on('click', '.view3', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'jurnal_nomor/jurnal_fn/jurnal_hutang_incoming/'+id+'/'+pp+'/'+akses,
			data:{'id':id},
			success:function(data){
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
