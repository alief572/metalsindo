					...
					<div class="row">
						...
						<div class="col-sm-12">
							<div class="col-sm-6">
								<div class="form-group row">
									<div class="col-md-4">
										<label for="customer">Total Incoming</label>
									</div>
									<div class="col-md-8">
										<input type="number" class="form-control" id="total" required name="total" required>
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group row">
									<div class="col-md-4">
										<label for="sj_supplier">No. Surat Jalan (Supplier)</label>
									</div>
									<div class="col-md-8">
										<input type="text" name="sj_supplier" id="" class="form-control">
									</div>
								</div>
							</div>
						</div>
