...
$material	= $this->db->query("SELECT * FROM dt_incoming_customer WHERE id_data = '".$head->id_data."' ")->result();
$suplier	= $this->db->query("SELECT * FROM master_customers WHERE id_customer = '".$head->id_suplier."' ")->result();
    ...
    <div class="box-body">
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8">
				<label>: <?= strtoupper($suplier[0]->name_customer)?></label>
			</div>
			</div>
		</div>
		</div>
