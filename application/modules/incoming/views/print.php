    ...
    <table class='gridtable' cellpadding='0' cellspacing='0' width='100%' style='width:100% !important;'>
        ...
        <tbody id="data_request" style='vertical-align:top;'>
            ...
            foreach ($detail as $material) {
				...
				<td	align='right'>" . number_format($material->length, 2) . "</td>
				<td	align='right'>" . number_format($material->width, 2) . "</td>
				<td	align='right'>" . number_format($material->weight, 2) . "</td>
				<td	align='center'>" . number_format($material->qty_order) . "</td>
				<td	align='center'>" . number_format($material->qty_sheet) . "</td>
				<td	align='center'>" . number_format($material->qty_recive) . "</td>
				<td	align='right'>" . number_format($material->width_recive, 2) . "</td>
				<td	align='right'>" . $material->lotno . "</td>
				</tr>
				";
            }
            ?>
