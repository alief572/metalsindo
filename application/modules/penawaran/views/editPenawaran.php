					...
					<div class="col-sm-12">
						<div class="row">
							<div class="col-sm-2">
								<div class='form-group row'>
									<div class='col-md-12'>
										<label for='harga_penawaran'>Price / Sheet</label>
									</div>
								</div>
							</div>
							<div class="col-sm-10">
								<div class='form-group row'>
									<div class='col-md-12' id="tempate_price_sheet">
										<input type='text' class='form-control autoNumeric' id='price_sheet' value="<?= $penawaran->price_sheet ?>" required name='price_sheet' placeholder='Price Sheet'>
									</div>
								</div>
							</div>
						</div>
