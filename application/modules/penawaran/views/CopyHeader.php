 ...
 <div class="box box-primary">
    <div class="box-body">
		...
		<div class="form-group row">
			...
			<div class="col-md-8">
				<input type="date" class="form-control tanggal" id="tanggal" value="<?= $head->tgl_penawaran ?>" onkeyup required name="tanggal">
			</div>
		</div>
		</div>
		</div>
		...
		<div class='form-group row'>
			...
			<div class='col-md-8'>
				<input type='date' class='form-control tanggal' id='valid_until' value="<?= $head->valid_until ?>" required name='valid_until' >
			</div>
		</div>
		</div>
		<div class='col-sm-4'>
			<div class='form-group row'>
				...
				<div class='col-md-8' id="pic_slot" >
					<input type='text' class='form-control' id='terms_payment' value="<?= $head->terms_payment ?>"  required name='terms_payment' >
				</div>
			</div>
		</div>
		<div class='col-sm-4'>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'penawaran/SaveCopyHeader';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
