				...
				<tr>
					<td colspan='2'>
						<table class='col-sm-12' border='1'>
							<tr align='center'>
								<th>
									<center><label>Quotation</label></center>
								</th>
							</tr>
						</table>
					</td>
							...
							<tr align='center'>
								<td>
									<table size='50%'>
										...
										<tr>
											<td colspan='4'>Jl. Jababeka XIV, Blok J no. 10 H</td>
										</tr>
										<tr>
											<td colspan='4'>Cikarang Industrial Estate, Bekasi 17530</td>
										</tr>
										<tr>
											<td>PHONE :</td>
										...
										<center>
											<table>
												<tr>
													<td>Customer</td>
													<td>:</td>
													<td><?= $header->name_customer ?></td>
												</tr>
												<tr>
													<td>Address</td>
													<td>:</td>
													<td><?= $header->address_office ?></td>
												</tr>
												<tr>
													<td>Phone</td>
													<td>:</td>
							...
							<table class='col-sm-12' border='1'>
								...
								?>
									<tr>
										...
										<td><?= $detail->nilai ?></td>
										<td><?= $detail->width ?></td>
										<td><?php if ($detail->id_bentuk == 'B2000001') {
												echo "C";
											} else {
												echo "$detail->length";
											}; ?></td>
					...
					<td colspan='2'>
						<table class='col-sm-12' border='1'>
							...
							<tr>
								...
								<td>
									<center>Terms Of Payment</center>
								</td>
								<td rowspan='2'>
									<center><?= $header->pengiriman ?>,<?php if ($header->pengiriman == 'Loco') {
								...
								<td rowspan='2'>
									<center>Exclude vat <?= $header->exclude_vat ?> %</center>
								</td>
							</tr>
							<tr>
								<td>
									<center><?= $header->valid_until ?></center>
								</td>
								<td>
									<center><?= $header->terms_payment ?></center>
								</td>
							</tr>
						</table>
					</td>
