    ...
    <div class="box-body">
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8">
					<textarea id="alasan" name="alasan" class='form-control col-md-12' rows="4" cols="2000"><?= $head->alasan_revisi ?></textarea>
				</div>
			</div>
		</div>
		</div>
		...
		<div class='form-group row'>
			...
			<div class='col-md-8' id="email_slot">
				<select id="kategori_revisi" name="kategori_revisi" class="form-control select" required>
						<?php	
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'penawaran/SavePengajuanRevisi';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
