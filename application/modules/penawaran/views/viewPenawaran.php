				...
				<div class="input_fields_wrap2">
					...
					<div class="col-sm-12">
						<div class="row">
							...
							<div class="col-sm-10">
								<div class='form-group row'>
									<div class='col-md-12' id="tempat_price_sheet">
										<input type='text' class='form-control' id='price_sheet' value="<?= $penawaran->price_sheet ?>" required name='price_sheet' placeholder='Price Sheet'>
									</div>
								</div>
							</div>
						</div>
