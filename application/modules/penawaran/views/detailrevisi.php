...
<div class="box box-primary">
    <div class="box-body">
			...
			<div class="row">
		<center><label for="customer" ><h3>Revisi Penawaran</h3></label></center>
		<div class="col-sm-12">
		<div class="col-sm-6">
		...
		<div class='form-group row'>
			<div class='col-md-4'>
				<label for='email_customer'>Keterangan Approval</label>
			</div>
			<div class='col-md-8' id="ket_approval">
				<textarea class='form-control' readonly id='ket_approval'><?= $header->ket_approval ?></textarea>
			</div>
		</div>
		</div>
	...
	<div class="box-body">
		...
		<tr>
		    <td><?= $numb; ?></td>
			<td><?=$record->nama_category3.'|'.$record->maker?></td>
			<td>Rp. <?= number_format($record->harga_penawaran_cust,2) ?></td>
			<td><?=$record->ket_detail?></td>
...
<script type="text/javascript">
	...
	$(document).on('click', '.edit', function(e){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'penawaran/editRevisiPenawaran/'+id,
	...
	$(document).on('click', '.add', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'penawaran/addRevisiPenawaran/'+id,
			data:{'id':id},
			success:function(data){
				$("#dialog-popup").modal();				
				$("#ModalView").html(data);
	...
	$(document).on('click', '.view', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'penawaran/viewRevisiPenawaran/'+id,
			data:{'id':id},
			success:function(data){
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
