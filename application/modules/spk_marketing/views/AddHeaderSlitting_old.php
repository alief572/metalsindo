 ...
 <div class="box box-primary">
    <div class="box-body">
		<form id="data-form" method="post">
			...
			<div class="row">
		<center><label for="customer" ><h3>SPK MARKETING SLITTING</h3></label></center>
		<div class="col-sm-12">
		<div class="col-sm-6">
...
<script type="text/javascript">
	...
	function get_produk(){ 
		...
		$.ajax({
            type:"GET",
            url:siteurl+'spk_marketing/GetPenawaranSlitting',
            data:"no_penawaran="+no_penawaran,
            success:function(html){
