...
<div class="box">
	<div class="box-header">
			<?php if($ENABLE_VIEW) : ?>
			<a class="btn btn-success btn-sm" href="<?= base_url('/spk_marketing/addHeaderSlitting/') ?>"  title="Tambah"><i class="fa fa-plus">&nbsp;</i>Add</i></a>
			<?php endif; ?>
...
<script type="text/javascript">
	...
	$(document).on('click', '.view', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'spk_marketing/ViewHeaderslitting/'+id,
			data:{'id':id},
			success:function(data){
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
