<?php
	...
	$plan = $results['plan'];
	$noso = $hd->id_spkmarketing;
	$totalharga	= $this->db->query("SELECT SUM(total_harga) as total FROM dt_spkmarketing WHERE id_spkmarketing='$noso' ")->row();
    ...
    <div class="box-body">
		...
		<div class="col-sm-12">
		    <div class="col-sm-6">
		        <div class="form-group row">
			        <div class="col-md-4">
				        <label for="customer">Total SPK Marketing</label>
			        </div>
			        <div class="col-md-8">
				        <input type="text" class="form-control" id="total_so" required name="total_so" readonly placeholder="Pembayaran" value="<?=number_format($totalharga->total)  ?>">
			        </div>
		        </div>
		    </div>
			<div class="col-sm-6">
		        <div class="form-group row">
			        <div class="col-md-4">
				        <label for="customer">Total Pengiriman</label>
			        </div>
			        <div class="col-md-8">
		...
		<div class="col-sm-12">
		    <div class="col-sm-6">
		        <div class="form-group row">
			        <div class="col-md-4">
				        <label for="customer">Sisa Invoice Revenue</label>
			        </div>
			        <div class="col-md-8">
		    ...
		    <div class="col-sm-6">
		        <div class="form-group row">
			        <div class="col-md-4">
				        <label for="sisa_hpp">Sisa HPP Revenue</label>
			        </div>
			        <div class="col-md-8">
