...
class Budget_coa_model extends BF_Model
{
	...
	{
		$this->db->select('a.created_on_dept, a.revisi, a.tahun, a.status, a.kategori, a.divisi, SUM(a.total) as total, a.finance_tahun, c.nama as nm_dept');
		$this->db->from($this->table_name . ' a');
		$this->db->join('ms_department c', 'a.divisi = c.id', 'left');
		$this->db->where('a.status >', 0);
		$this->db->where('a.kategori', $kategori);
		$this->db->group_by('a.tahun, a.status, a.kategori, a.divisi, a.finance_tahun, c.nama, a.created_on_dept, a.revisi');
