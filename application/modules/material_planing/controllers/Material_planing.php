...
class Material_planing extends Admin_Controller
{
	...
	public function EditHeader()
	{
		...
		$stok_fg 	= $this->db->query("SELECT * FROM stock_material WHERE id_category3 = '$id_material' AND width >= '$width' AND id_gudang='3' AND sisa_spk > 0 AND (sisa_spk - IF(delivery_book IS NULL, 0, delivery_book)) > 0 ORDER BY width ASC ")->result();
	...
	public function SaveEditHeaderNew()
	{
		...
		$cust     = $this->db->query("SELECT * FROM master_customers WHERE id_customer = '$id_customer'")->row();
