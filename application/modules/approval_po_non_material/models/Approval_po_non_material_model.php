...
class Approval_po_non_material_model extends BF_Model
{
  ...
  public function data_side_approval_pr_material()
  {
    ...
    foreach ($query->result_array() as $row) {
      ...
      $approval_btn = '';
      if (has_permission('Approval_PO_Non_Material.Manage')) {
      ...
      //   </td></div>";
      $nestedData[]  = "<div align='center'>
        <a href='approval_po_non_material/po_approval/" . $row['no_po'] . "' class='btn btn-sm btn-success'><i class='fa fa-check'></i></a>
        </td></div>";
  ...
  public function get_query_approval_pr_material($product, $costcenter, $like_value = NULL, $column_order = NULL, $column_dir = NULL, $limit_start = NULL, $limit_length = NULL)
  {
    ...
    $sql = "SELECT
            ...
            FROM
              ...
              LEFT JOIN master_customers c ON c.id_customer = b.id_customer
