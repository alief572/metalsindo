...
class Approval_po_non_material extends Admin_Controller
{
  //Permission
  protected $viewPermission   = 'Approval_PO_Non_Material.View';
  protected $addPermission    = 'Approval_PO_Non_Material.Add';
  protected $managePermission = 'Approval_PO_Non_Material.Manage';
  protected $deletePermission = 'Approval_PO_Non_Material.Delete';

  public function __construct()
  {
    parent::__construct();

    $this->load->model(array('Approval_po_non_material/Approval_po_non_material_model'));
  ...
  {
    $this->Approval_po_non_material_model->data_side_approval_pr_material();
  }
  ...
  public function po_approval($no_po)
  {
    ...
    // $getitemso = $this->db->join('dt_trans_po_non_material x', 'x.idpr = a.id');
    ...
    $getitemso = $this->db->query("
        ...
        if(d.konversi IS NULL, 1, d.konversi) as konversi,
        '0' as konversi1,
        i.code as satuan,
        '' as satuan1,
        ...
        LEFT JOIN ms_satuan i ON i.id = d.id_unit
			WHERE
    ...
    $header_po = $this->db->get_where('tr_purchase_order_non_material', ['no_po' => $no_po])->row();
  ...
  public function approve_po_process()
  {
    ...
    $this->db->update('tr_purchase_order_non_material', ['status' => 2], ['no_po' => $post['no_po']]);
  ...
  public function reject_po_process()
  {
    ...
    $this->db->update('tr_purchase_order_non_material', ['status' => 1, 'reject_reason' => $post['reject_reason']], ['no_po' => $post['no_po']]);
