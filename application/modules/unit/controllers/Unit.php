...
{
	//Permission
	protected $viewPermission 	= 'Master_Unit_Measurement.View';
	protected $addPermission  	= 'Master_Unit_Measurement.Add';
	protected $managePermission = 'Master_Unit_Measurement.Manage';
	protected $deletePermission = 'Master_Unit_Measurement.Delete';
