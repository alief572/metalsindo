<?php
$ENABLE_ADD     = has_permission('Master_Unit_Measurement.Add');
$ENABLE_MANAGE  = has_permission('Master_Unit_Measurement.Manage');
$ENABLE_VIEW    = has_permission('Master_Unit_Measurement.View');
$ENABLE_DELETE  = has_permission('Master_Unit_Measurement.Delete');
?>
<style type="text/css">
	thead input {
		width: 100%;
