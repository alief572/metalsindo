...
<div class="box">
	<div class="box-header">
			<?php if($ENABLE_VIEW) : ?>
			    ...
			    <a class="btn btn-success btn-sm" target="_blank" href="assets/crcl/template_crcl_v2.pdf" title="Template CRCL">&nbsp;<i class="fa fa-download">Download</i>
				    </a>
	...
	<div class="box-body">
		...
		<tr>
			...
			<?php if($ENABLE_VIEW) : ?>
				...
				<?php if($record->doc <> null) : ?> 
					<a class="btn btn-success btn-sm" href="assets/crcl/<?= $record->doc ?>" title="View CRCL"><i class="fa fa-eye"></i>
				    </a>
					<?php endif; ?>	
			...
			<?php if($ENABLE_DELETE) : ?>
				<a class="btn btn-warning btn-sm" href="<?= base_url('/transaksi_inquiry/editInquiry/'.$record->no_inquiry) ?>" title="Detail" data-no_inquiry="<?=$record->no_inquiry?>"><i class="fa fa-pencil"></i>
				</a>
			<?php endif; ?>
			</td>
