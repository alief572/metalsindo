 ...
 <div class="box box-primary">
    <div class="box-body">
		...
		<div class="form-group row">
			...
			<div class="col-md-8">
				<input type="text" class="form-control" id="id_surat_CRCL" required name="id_surat_CRCL" placeholder="Id Surat CRCL" readonly>
			</div>
		</div>
		</div>
		<div class="col-sm-6">
		...
		<div class="form-group row">
			...
			<div class="col-md-8" hidden>
				...
				<input type="text" class="form-control" id="id_bentuk"  value ="B2000001" required name="id_bentuk" readonly placeholder="No.CRCL">
			</div>
			<div class="col-md-8">
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-4">
				<input type="number" class="form-control" id="berat_produk" required placeholder="MIN"  name="berat_produk" onkeyup="hitungmasa()">
				</div>
				<div class="col-md-4">
				<input type="number" class="form-control" id="berat_produk_max" required placeholder="MAX" name="berat_produk_max" onkeyup="hitungmasa()">
				</div>
			</div>
		</div>
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group row" id="tempat_berat">
				...
				<div class="col-md-8">
				<input type="number" class="form-control" id="panjang" readonly required name="panjang">
				</div>
			</div>
		</div>
		<div class="col-sm-6">
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8">
				<input type="text" class="form-control" id="odiameter" required name="odiameter" placeholder="Max">
				</div>
			</div>
		</div>
