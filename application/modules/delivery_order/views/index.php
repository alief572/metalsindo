	...
	<div class="box-body">
		...
		<tr>
			...
			<?php if($ENABLE_VIEW) : ?>
				...
				<a class="btn btn-success btn-sm" href="<?= base_url('/delivery_order/PrintHeaderWord/'.$record->id_delivery_order) ?>" target="_blank" title="Print Word"><i class="fa fa-file-word-o"></i>
				</a>
				<a class="btn btn-success btn-sm" href="<?= base_url('/delivery_order/PrintHeaderHtml/'.$record->id_delivery_order) ?>" target="_blank" title="Ke Printer"><i class="fa fa-print"></i>
				</a>
				<a class="btn btn-warning btn-sm" href="<?= base_url('/delivery_order/PrintHeaderSlitting/'.$record->id_delivery_order) ?>" target="_blank" title="Print"><i class="fa fa-print"></i>
				</a>
				<a class="btn btn-primary btn-sm" href="<?= base_url('/delivery_order/PrintHeaderWordSlitting/'.$record->id_delivery_order) ?>" target="_blank" title="Print Word Slitting"><i class="fa fa-file-word-o"></i>
				</a>
			<?php endif; ?>
			</td>
			<?php }else{ ?>
			...
			<?php endif; ?> -->
			<?php if($ENABLE_VIEW) : ?>
				<a class="btn btn-primary btn-sm" href="<?= base_url('/delivery_order/PrintHeaderHtml/'.$record->id_delivery_order) ?>" target="_blank" title="Print"><i class="fa fa-print"></i>
			</a>
				<a class="btn btn-success btn-sm" href="<?= base_url('/delivery_order/PrintHeaderWord/'.$record->id_delivery_order) ?>" target="_blank" title="Print Word"><i class="fa fa-file-word-o"></i>
				</a>
				<a class="btn btn-warning btn-sm" href="<?= base_url('/delivery_order/PrintHeaderSlitting/'.$record->id_delivery_order) ?>" target="_blank" title="Print"><i class="fa fa-print"></i>
