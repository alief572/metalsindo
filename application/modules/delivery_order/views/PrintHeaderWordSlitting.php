...
<body>
    ...
    <b>
        ...
        <table class='gridtable' border="1" width='100%' align="center" cellpadding="2" cellspacing="0">
            ...
            ?>
                ...
                <tr>
                    ...
                    <td width="180"><?= $dtl->nm_material ?></td>
                    <td width="55"><?= $spec ?></td>
        ...
        <table class='gridtable' border="1" width='100%' align="center" cellpadding="2" cellspacing="0">
            ...
            $dtslitting = $this->db->query("SELECT *  FROM dt_delivery_order_child_scrap WHERE id_delivery_order ='$header->id_delivery_order'")->result();
            ?>
            ...
            $widthsl = "";
            $isl = 0;
            foreach ($dtslitting as $dtlsl) {

                if ($isl > 0) {

                    if ($id_materialsl != $dtlsl->id_material) {
            ...
            ?>
                        ...
                        <tr>
                            ...
                            <td bgcolor="#c9c9c9"></td>
                            <td bgcolor="#c9c9c9"></td>
                            <td bgcolor="#c9c9c9" align="center"><?= number_format($qtysl, 2) ?> </td>
                            <td bgcolor="#c9c9c9"></td>
                            <td bgcolor="#c9c9c9" align="center"><?= number_format($beratsl, 2) ?></td>
                            <td bgcolor="#c9c9c9"></td>
                        </tr>
                ...
                $SUMKGsl += $dtlsl->weight_mat;
                $SUMQTYsl += $dtlsl->qty_mat;



                $bentuksl = $dtlsl->bentuk;
                $lengthsl = $dtlsl->length;
                if ($dtlsl->length <= 0) {
                    $lengthsl = 'C';
                }
                $coilsl = 'C';
                ...
                $specsl = number_format($dtlsl->thickness, 2) . ' x ' . floatval($dtlsl->width) . ' x ' . $coilsl;
                ?>
                <tr>
                    <td width="8" align="center"><?= $loopsl ?></td>
                    <td width="100"><?= $dtlsl->nm_material . ',' . $dtlsl->part_number ?></td>
                    <td width="55"><?= $specsl ?></td>
                    <td width="145" align="left"><?= $dtlsl->lotno ?></td>
                    <td width="20" align="center"><?= number_format($dtlsl->qty_mat, 0); ?></td>
                    <td width="25" align="right"></td>
                    <td width="20" align="right"><?= $dtlsl->weight_mat; ?></td>
                    <td width="60" align="center"><?= $dtlsl->remark ?></td>
                </tr>
            ...
            <?php
                ...
                $width = $dtlsl->width;
                $id_materialsl = $dtl->id_material;
                $qtysl = $qtysl + $dtlsl->qty_mat;
                $beratsl = $beratsl + $dtlsl->weight_mat;
            }
            ?>
            <tr>
                <td bgcolor="#c9c9c9"></td>
            ...
            <tr>
                ...
                <th bgcolor="#c9c9c9" rowspan='2' align="center" valign="middle" width="55"></th>
                <th bgcolor="#c9c9c9" rowspan='2' align="center" valign="middle" width="135"></th>
                <th bgcolor="#c9c9c9" width="20" align="center"><?= $SUMQTYsl ?></th>
                <th bgcolor="#c9c9c9" width="25" align="center"></th>
                <th bgcolor="#c9c9c9" width="20" align="center"><?= $SUMKGsl ?></th>
                <th bgcolor="#c9c9c9" rowspan='2' align="center" valign="middle" width="60"></th>
            </tr>
        ...
        <table class='gridtable' border="1" width='100%' align="center" cellpadding="2" cellspacing="0">
            <tr>
                <th bgcolor="#c9c9c9" rowspan='2' align="center" valign="middle" width="8"></th>
                <th bgcolor="#c9c9c9" rowspan='2' align="center" valign="middle" width="110">TOTAL KESELURUHAN</th>
                <th bgcolor="#c9c9c9" rowspan='2' align="center" valign="middle" width="55"></th>
                <th bgcolor="#c9c9c9" rowspan='2' align="center" valign="middle" width="135"></th>
                <th bgcolor="#c9c9c9" width="20" align="center"></th>
                <th bgcolor="#c9c9c9" width="25" align="center"></th>
                <th bgcolor="#c9c9c9" width="20" align="center"><?= $SUMKGsl + $SUMKG ?></th>
                <th bgcolor="#c9c9c9" rowspan='2' align="center" valign="middle" width="60"></th>
            </tr>
