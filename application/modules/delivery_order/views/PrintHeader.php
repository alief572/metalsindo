			...
			?>
						<tr>
							...
							if (empty($part_number)) {
								...
								$stock = $this->db->get_where('stock_material', array('id_stock' => $lot->id_stock))->row();
								if (empty($stock)) {
									$stock = $this->db->get_where('stock_material', array('lotno' => $lot->lotno))->row();
								}
							...
							?>
							<td align="center"><?= $lot->id_material . ', ' . $part_number ?></td>
							<td align="center"><?= $lot->no_alloy ?></td>
							<td width="50" align="center"><?= $lot->lotno ?></td>
							<td width="50" align="center"><?= $lot->lot_slitting ?></td>
							...
							<td width="60" align="center"><?= $lot->weight_mat   ?></td>
							<td width="60" align="center"><?= $lot->remark ?></td>
						</tr>
