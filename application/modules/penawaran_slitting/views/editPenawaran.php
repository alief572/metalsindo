 ...
 <div class="box box-primary">
    <div class="box-body">
		<form id="data-form" method="post">
					...
					<label  for='forecast'>REVISI PENAWARAN</label>
					</div>
					...
					<select id="id_category3" name="id_category3" class="form-control select" onchange="getproperties()" required>
						...
						?>
						<option value="<?= $inventory_3->id_category3?>" <?= $select ?>><?= strtoupper(strtolower($inventory_3->nama.'|'.$inventory_3->maker.'|'.$inventory_3->negara))?></option>
						<?php } ?>
					</select>
									    </div>
										</div>
					...
					<div class="col-sm-12">
						...
						<div class="col-sm-6" >
										<div class='form-group row'>
										<div class='col-md-4'>
									    <label for='forecast'>Keterangan Revisi</label>
									    </div>
									    <div class='col-md-8' id="untuk_inven1" hidden>
										<input type='text' class='form-control' id='inven1'  value="<?= $penawaran->inven1?>"   required name='inven1' placeholder='Bentuk Material'>
									    <input type='text' class='form-control' value="<?= $penawaran->no_penawaran?>" readonly id='no_penawaran'  required name='no_penawaran' placeholder='Bentuk Material'>
										</div>
										<div class='col-md-8'>
										<textarea class='form-control' id='ket_detail' name='ket_detail'><?= $penawaran->ket_detail?></textarea>
									    </div>
										</div>
						</div>							
						</div>	
		...
		$k30 =  number_format($nomkurs30,2);
			...
			<table class='col-sm-12' border='1' cellspacing='0'>
					...
					<div class="col-sm-12">
						...
						<div class='form-group row'>
									    <div class='col-md-12'>
										<input type='text' class='form-control autoNumeric' id='bottom' value="<?= $penawaran->bottom?>"  required name='bottom' placeholder='Bottom Price'>
									    </div>
										</div>
						</div>
						<div class="col-sm-5">
					...
					<div class="col-sm-12">
						...
						<div class='form-group row'>
									    <div class='col-md-12'>
										<input type='text' class='form-control autoNumeric' id='komisi' value="<?= $penawaran->komisi?>" required name='komisi' onkeyup="hitungkomisi()" placeholder='Komisi'>
									    </div>
										</div>
						</div>
						<div class="col-sm-5">
						...
						<div class='form-group row'>
										...
										<input type='text' class='form-control autoNumeric' id='profit' value="<?= $penawaran->profit?>"  required name='profit' onkeyup="hitungkomisi()" placeholder='Komisi'>
									    </div>
										</div>
						</div>
						<div class="col-sm-2">
						...
						<div class="row">
							...
							<div class="col-sm-10">
								<div class='form-group row'>
									...
									<input type='text' class='form-control autoNumeric' id='harga_penawaran' value="<?= $penawaran->harga_penawaran?>"  required name='harga_penawaran' placeholder='Bentuk Material'>
									</div>
									</div>
								</div>					
							</div>	
					...
					<div class="col-sm-12">
						<div class="row">
							...
							<div class="col-sm-10">
								<div class='form-group row'>
									<div class='col-md-12'>
									<input type='text' class='form-control autoNumeric' id='harga_penawaran_cust' value="<?= $penawaran->harga_penawaran_cust?>"  required name='harga_penawaran_cust'>
									</div>
									</div>
								</div>					
							</div>	
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'penawaran_slitting/saveEditRevisiPenawaran';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
...
function getproperties(){
	...
	// $(document).on('keyup','#bottom', function(){
	// 	var bottom 		= getNum($(this).val().split(",").join(""));
	// 	var komisi 		= getNum($("#komisi").val().split(",").join(""));
	// 	var profit 		= getNum($("#profit").val().split(",").join(""));

	// 	var nil_komisi 	= bottom * (komisi / 100);
	// 	var nil_profit	= bottom * (profit / 100);
	// 	var harga_penawaran		= bottom + nil_komisi + nil_profit;
	// 	// console.log(profit)
	// 	$("#harga_penawaran").val(number_format(harga_penawaran,2));
	// });
