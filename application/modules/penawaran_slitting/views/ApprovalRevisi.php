 ...
 <div class="box box-primary">
    <div class="box-body">
		<form id="data-form" method="post">
			...
			<div class="row">
		<center><label for="customer" ><h3>Ajukan Revisi Penawaran</h3></label></center>
		<div class="col-sm-12">
		<div class="col-sm-6">
		<div class="form-group row">
			...
			<div class="col-md-8" hidden>
				<input type="text" class="form-control" id="no_penawaran_lama" value="<?= $head->no_penawaran ?>"  required name="no_penawaran_lama" readonly placeholder="No.CRCL">
				<input type="hidden" class="form-control" id="no_penawaran" required name="no_penawaran" readonly placeholder="No.CRCL">
			</div>
			<div class="col-md-8">
		...
		<div class="form-group row">
			...
			<div class="col-md-8">
				<input type="date" class="form-control tanggal" id="tanggal" value="<?= $head->tgl_penawaran ?>" onkeyup required name="tanggal" readonly>
			</div>
		</div>
		</div>
		</div>
		...
		<div class='col-sm-6'>
			<div class='form-group row'>
				...
				<div class='col-md-8' id="pic_slot" >
					<select id='pic_customer' name='pic_customer' class='form-control select' readonly required>
						<option value=''>--Pilih--</option>
		...
		<div class='form-group row'>
			...
			<div class='col-md-8' id="email_slot">
				<select id="mata_uang" name="mata_uang" class="form-control select" readonly required>
						<?php
		...
		<div class='form-group row'>
			...
			<div class='col-md-8' id="">
					<select id="pengiriman" name="pengiriman" class="form-control select" readonly required>
												<?php
		...
		<div class='form-group row'>
			...
			<div class='col-md-8'>
				<input type='date' class='form-control tanggal' id='valid_until' value="<?= $head->valid_until ?>" required name='valid_until' readonly >
			</div>
		</div>
		</div>
		<div class='col-sm-4'>
			<div class='form-group row'>
				...
				<div class='col-md-8' id="pic_slot" >
					<input type='text' class='form-control' id='terms_payment' value="<?= $head->terms_payment ?>"  required name='terms_payment' readonly >
				</div>
			</div>
		</div>
		<div class='col-sm-4'>
			<div class='form-group row'>
				...
				<div class='col-md-8' >
					<input type='number' class='form-control' id='exclude_vat' value="<?= $head->exclude_vat ?>"  required name='exclude_vat'  readonly>
				</div>
			</div>
		</div>
		</div>
		...
		<div class='form-group row'>
			...
			<div class='col-md-8'>
				<textarea id="note" name="note" class='form-control col-md-12' rows="4" cols="2000" readonly><?= $head->note ?></textarea>
			</div>
		</div>		
		</div>
		<div class="col-sm-6">
			<div class="form-group row">
				<div class="col-md-4">
					<label for='email_customer'>Alasan Revisi</label>
				</div>
				<div class="col-md-8">
					<textarea id="alasan" name="alasan" class='form-control col-md-12' rows="4" cols="2000" readonly><?= $head->alasan_revisi ?></textarea>
				</div>
			</div>
		</div>
		</div>
		...
		<div class='form-group row'>
			<div class='col-md-4'>
				<label for='revisi'>Kategori Revisi</label>
			</div>
			<div class='col-md-8' id="email_slot">
				<select id="kategori_revisi" name="kategori_revisi" class="form-control select" required readonly>
						<?php	
						if($head->kategori_revisi ==1){ 
						echo"
						<option value=''>--Pilih--</option>
						<option value='1' selected>Ganti Material</option>
						<option value='2'>Tambah Material</option>";
						}elseif($head->kategori_revisi ==2){
						echo"
						<option value=''>--Pilih--</option>
						<option value='1'>Ganti Material</option>
						<option value='2' selected>Tambah Material</option>";	
						}
						else{
						echo"
						<option value=''>--Pilih--</option>
		...
		<div class='form-group row'>
			<div class='col-md-4'>
				<label for='revisi'>Status Approval</label>
			</div>
			<div class='col-md-8' id="email_slot">
				<select id="status_approval" name="status_approval" class="form-control select" required>
						<?php	
		...
		<div class='form-group row'> 
			<div class='col-md-4'>
				<label for='ket_approval'>Keterangan Approval</label>
			</div>
			<div class='col-md-8'>
				<textarea id="ket_approval" name="ket_approval" class='form-control col-md-12' rows="4" cols="2000"><?= $head->ket_approval ?></textarea>
			</div>
		</div>		
		</div>
		<div class="col-sm-6">
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'penawaran/SaveApprovalRevisi';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
