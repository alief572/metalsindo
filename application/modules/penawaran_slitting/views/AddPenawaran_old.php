		...
		<form id="data-form" method="post">
			<div class="col-sm-12">
				<div class="col-sm-12" align="center">
					<label  for='forecast'>PENAWARAN SLITTING</label>
				</div>
			</div>
					...
					<div class="col-sm-12">
						...
						<div class="col-sm-6" >
									    ...
									    <div class="col-md-8">
										<input type='text' class='form-control'  id='bentuk_material'  required name='bentuk_material' placeholder='Bentuk Material'>
									    </div>
										 <div class="col-md-8" hidden>
										<input type='text' class='form-control'  id='id_bentuk'  required name='id_bentuk' placeholder='Bentuk Material'>
									    </div>
										</div>
						</div>						
						</div>	
					...
					<div class="col-sm-12">
						...
						<div class="col-sm-6">
										...
										<input type='text' class='form-control'  id='thickness'  required name='thickness' placeholder='Thickness'>
										</div>
										
										<div hidden>
										<input type='text' class='form-control'  id='id_child_penawaran'  required name='id_child_penawaran' placeholder='Thickness'>
										</div>
										</div>
						</div>
						<div class="col-sm-6">
										...
										<input type='text' class='form-control'  id='density'   required name='density' placeholder='Density'>
									    </div>
										</div>
						</div>						
						</div>	
					...
					<div class="col-sm-12">
						...
						<div class="col-sm-6">
										<div class='form-group row'>
										<div class='col-md-4'>
									    <label for='forecast'>Qty Slitting(Kg)</label>
									    </div>
									    <div class='col-md-8'>
										<input type='hidden' class='form-control' id='forecast'  onkeyup="carimsprofit()" required name='forecast' placeholder='Forecats/Month'>
									    <input type='text' class='form-control' id='qty_slitting'  required name='qty_slitting' placeholder='Qty Slitting(Kg)'>
						...
						<div class="col-sm-6">
										<div class='form-group row'>
										<div class='col-md-4'>
									    <label for='forecast'>Width Awal</label>
									    </div>
									    <div class='col-md-8' >
					...
					<div class="col-sm-12">
						...
						<div class="col-sm-6">
										<div class='form-group row'>
										<div class='col-md-4'>
									    <label for='forecast'>Qty Coil</label>
									    </div>
									    <div class='col-md-8'>
										<input type='text' class='form-control' id='qty_coil' required name='qty_coil' placeholder='Qty Coil'>
									    </div>
										</div>
						</div>	
						<div class="col-sm-6">
										<div class='form-group row'>
										<div class='col-md-4'>
									    <label for='forecast'>Width Akhir</label>
									    </div>
									    <div class='col-md-8' >
										<input type='text' class='form-control' id='width_akhir'   required name='width_akhir' placeholder='Width Akhir'>
									    </div>
										</div>
						</div>							
						</div>	
					...
					<div class="col-sm-12">
						...
						<div class="col-sm-6">
										<div class='form-group row'>
										<div class='col-md-4'>
									    <label for='forecast'>Estimasi Lead Time</label>
									    </div>
									    <div class='col-md-8'>
										<input type='text' class='form-control' id='estimasi' required name='estimasi' placeholder='Estimasi Lead Time'>
									    </div>
										</div>
						</div>	
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'penawaran_slitting/saveNewPenawaran';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
...
function getproperties(){
		...
		$.ajax({
            type:"GET",
            url:siteurl+'penawaran_slitting/cari_bentuk',
		...
		$.ajax({
            type:"GET",
            url:siteurl+'penawaran_slitting/cari_density',
            data:"id_category3="+id_category3,
            success:function(html){
		...
		$.ajax({
            type:"GET",
            url:siteurl+'penawaran_slitting/cari_thickness',
            data:"id_category3="+id_category3,
            success:function(html){
		...
		$.ajax({
            type:"GET",
            url:siteurl+'penawaran_slitting/cari_pricelist',
            ...
            success:function(html){
               $("#untuk_pricelist").html(html);
				...
				$.ajax({
            type:"GET",
            url:siteurl+'penawaran_slitting/cari_inven1',
            data:"id_category3="+id_category3,
            success:function(html){
	...
	function hitungkomisi(){
		...
		var profit= getNum($("#profit").val().split(",").join(""));
		 $.ajax({
            type:"GET",
            url:siteurl+'penawaran_slitting/hitung_komisi',
	...
	function carimsprofit()
    {
		...
		var forecast=$("#forecast").val();
		 $.ajax({
            type:"GET",
            url:siteurl+'penawaran_slitting/carimsprofit',
