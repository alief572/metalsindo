...
class Purchase_order_non_material extends Admin_Controller
{
	//Permission
	protected $viewPermission 	= 'Purchase_Order_Non_Material.View';
	protected $addPermission  	= 'Purchase_Order_Non_Material.Add';
	protected $managePermission = 'Purchase_Order_Non_Material.Manage';
	protected $deletePermission = 'Purchase_Order_Non_Material.Delete';
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			'Purchase_order_non_material/Pr_model',
	...
	public function index()
	{
		...
		FROM 
			...
			LEFT JOIN master_supplier h ON h.id_suplier = a.id_suplier
	...
	")->result();
		...
		$this->template->title('Purchase Order Non Material');
