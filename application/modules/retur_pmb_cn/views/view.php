                        ...
                        <tfoot class="bg-primary">
                            ...
                            <tr>
                                ...
                                <th>
                                    ...
                                    <input type="text" name="ppn" id="" class="form-control form-control-sm text-right auto_num hitung_grand_total" value="<?= $header->nilai_ppn ?>" readonly>
                                </th>
                            </tr>
                            <tr>
                                <th class="text-right" colspan="4">Grand Total</th>
                                <th>
                                    <input type="text" name="grand_total" id="" class="form-control form-control-sm text-right auto_num" value="<?= $header->grand_total ?>" readonly>
                                </th>
                            </tr>
                        </tfoot>
                    </table>
